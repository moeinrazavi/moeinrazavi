...
const experiences = [
  ...
  },
  {
    ...
    highlights: [
      'Building AI-powered objective pain measurement technology featured in Nature Magazine (Sept 2024), achieving >90% accuracy across 400+ clinical patients',
      'Built Python REST APIs (Flask, FastAPI) with WebSocket for real-time biosignal streaming handling 10K+ concurrent connections',
      'Developed SwiftUI iOS clinical applications (Vitality, Clinical App) with CoreUSB hardware integration for near-infrared spectroscopy sensors',
      'Created React/Next.js healthcare dashboard with MongoDB, Redux, JWT auth, and real-time data visualization',
      'Contributing to FDA investigational technology backed by >$2M in NSF and FDA grant funding',
    ],
    technologies: ['FastAPI', 'Flask', 'SwiftUI', 'React', 'Next.js', 'MongoDB', 'WebSocket', 'iOS', 'ML/AI'],
  },
  {
